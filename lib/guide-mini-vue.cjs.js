...
function createRenderer(options) {
    ...
    function mountElement(vnode, contariner, parentComponent, anchor) {
    ...
    function processFragment(n1, n2, contariner, parentComponent, anchor) {
...
const CREATE_ELEMENT_VNDOE = Symbol('createElementVNode');
const helperMapName = {
    [TO_DISPLAY_STRING]: 'toDisplayString',
    [CREATE_ELEMENT_VNDOE]: 'createElementVNode'
};
...
function genElement(node, context) {
    ...
    push(`${helper(CREATE_ELEMENT_VNDOE)}(`);
...
function parserElement(context, ancestors) {
    // 1 解析tag
